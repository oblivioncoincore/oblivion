...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help") || gArgs.IsArgSet("-version"))
    {
        ...
        std::string strUsage = strprintf(_("%s oblivion-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  oblivion-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded oblivion transaction") + "\n" +
              "  oblivion-tx [options] -create [commands]   " + _("Create hex-encoded oblivion transaction") + "\n" +
              "\n";
