...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Oblivion address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and oblivion: URIs)"));
...
//    connect(multisigAction, SIGNAL(triggered()), this, SLOT(gotoMultisigPage()));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Oblivion addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/verify"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Oblivion addresses"));
    ...
    openAction->setStatusTip(tr("Open a oblivion: URI or payment request"));

    showHelpMessageAction = new QAction(QIcon(":/icons/info"), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible Oblivion command-line options").arg(tr(PACKAGE_NAME)));

    openChatroomAction = new QAction(QIcon(":/icons/oblivion"), tr("&Chatroom"), this);
    openChatroomAction->setStatusTip(tr("Open the Oblivion Discord in a web browser."));

    openForumAction = new QAction(QIcon(":/icons/oblivion"), tr("&Forum"), this);
    openForumAction->setStatusTip(tr("Open https://talk.oblivion.net in a web browser."));
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        tooltip = tr("%n active connection(s) to Oblivion network", "", count) + QString(".<br>") + tr("Click to disable network activity.");
    } else {
...
{
    QString strTitle = tr("Oblivion"); // default title
