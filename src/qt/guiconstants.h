...
#define QAPP_ORG_NAME "Oblivion"
#define QAPP_ORG_DOMAIN "oblivion.net"
#define QAPP_APP_NAME_DEFAULT "Oblivion-Qt"
#define QAPP_APP_NAME_TESTNET "Oblivion-Qt-testnet"
